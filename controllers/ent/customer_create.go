...
func (cc *CustomerCreate) SetNillableFullName(s *string) *CustomerCreate {
	if s != nil {
		cc.SetFullName(*s)
	}
	return cc
...
func (cc *CustomerCreate) SetBillingAddress(s string) *CustomerCreate {
	cc.mutation.SetBillingAddress(s)
	return cc
}

// SetNillableBillingAddress sets the "billing_address" field if the given value is not nil.
func (cc *CustomerCreate) SetNillableBillingAddress(s *string) *CustomerCreate {
	if s != nil {
		cc.SetBillingAddress(*s)
	}
	return cc
}
